...
export function HeroSection() {
  ...
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-purple-50 to-indigo-50/30"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-600/10 text-purple-600 mb-8 animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-up delay-400">
            ...
            <Button
              size="lg"
              variant="outline"
              className="px-8 py-4 text-lg font-semibold border-2 hover:bg-purple-600 hover:text-white bg-transparent border-purple-600 text-purple-600"
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 animate-fade-in-up delay-600">
            <div className="text-center">
              <div className="text-3xl font-bold font-serif text-purple-600 mb-2">2-3 weeks</div>
              <div className="text-muted-foreground">MVP Delivery</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold font-serif text-purple-500 mb-2">AI-Powered</div>
              <div className="text-muted-foreground">Learning Solutions</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold font-serif text-indigo-500 mb-2">Enterprise</div>
